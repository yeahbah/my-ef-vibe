...
/// <summary>
/// Pomelo's <c>UseMySql</c> requires an explicit <c>ServerVersion</c>; unlike SQL Server/Npgsql two-parameter overloads.
/// </summary>
internal static class PomeloMySqlConfigurator
{
        ...
        MyEfVibeProvider providerKey)
    {
                                                                   ...
                                                                   | BindingFlags.NonPublic))
        {
            ...
            {
                3 => new object?[] { closedBuilderInstance, connectionString, serverVersion },
                4 => new object?[] { closedBuilderInstance, connectionString, serverVersion, null },
                _ => null,
            };
    ...
    private static bool IsServerVersionType(Type parameterType) =>
        string.Equals(parameterType.Name, "ServerVersion", StringComparison.Ordinal)
