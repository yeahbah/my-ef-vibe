...
{
    [Value(0, MetaName = "mode", Required = true,
        HelpText = "Scan mode: lite (static heuristics) or deep (heuristics + SQL translation).")]
    ...
    [Option("respect-dismissals", Default = false,
        HelpText = "Exclude findings previously dismissed in the REPL session.")]
    ...
    [Option("connection-string", HelpText = "Connection string for deep scan.")]
