...
Rider extension — install from the [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/31961-my-ef-vibe) (search **`My EF Vibe`**). Per-project settings, `efvibe serve` daemon, terminal REPL, Run Selection, model actions, scan review, notebooks, and a structured tool window ([rider-extension/README.md](rider-extension/README.md) · [docs/rider-extension.md](docs/rider-extension.md)):
