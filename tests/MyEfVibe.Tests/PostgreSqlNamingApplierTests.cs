...
public sealed class PostgreSqlNamingApplierTests
{
    [Theory]
    ...
    public void ResolveColumnName_maps_id_suffix_to_uppercase_id(string propertyName, string expected)
    {
        ...
        var resolved = PostgreSqlNamingApplier.ResolveColumnName(propertyName, columns);
    ...
    public void ResolveColumnName_maps_rowguid_to_lowercase_when_present()
    {
        ...
        var resolved = PostgreSqlNamingApplier.ResolveColumnName("Rowguid", columns);
    ...
    public void RequiresBoolSmallintConversion_matches_bool_smallint_pairs(
        ...
        bool expected)
    {
        Assert.Equal(expected, PostgreSqlNamingApplier.RequiresBoolSmallintConversion(clrType, dataType));
    }
}
